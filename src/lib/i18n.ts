...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "emotion.thanks.hint":  { zh: "也可以只写一句话",                   en: "You can also write just one sentence" },
  ...
  "result.more.pre":        { zh: "喜欢这个解读？打赏一下吧",           en: "Like this reading? Buy me a coffee" },
  "result.more":            { zh: "☕ 请我喝杯咖啡",                    en: "☕ Buy me a coffee" },
